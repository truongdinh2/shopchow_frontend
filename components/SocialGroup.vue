<template>
  <div class="flex mx-2 mb-9 lg:mx-4 flex-wrap">
    <div class="rounded-lg bg-footer-upper pt-1 pb-3 basis-1/3 lg:basis-[calc(100%/3-10.66px)]">
      <div class="flex justify-center">
        <NuxtImg src="/social-media-connection.png" sizes="sm:50px md:70px lg:70px"></NuxtImg>
      </div>
