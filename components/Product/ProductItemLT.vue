  ...
  <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300">
    <a href="#">
      <div class="relative flex items-end h-52">
        ...
        <nuxt-img class="h-full mx-auto" src="anh-ao-mau.png" fit="cover" width="260" height="150" />
      ...
      <div class="mt-1 p-2">
        ...
        <div class="flex justify-between items-center">
          ...
          <span v-if="discountType == 1" class="text-sm line-through">{{ formatMoney(300000) }}</span>
          <span v-if="discountType == 2" class="text-sm line-through">giam 30%</span>
        </div>
        <p class="mt-1 text-sm d-webkit-box text-slate-400 overflow-hidden text-ellipsis">Đoạn giới thiệu sơ qua. Dài quá thì see more. sjjdĐoạn giới thiệu sơ qua. Dài quá thì see more...</p>
